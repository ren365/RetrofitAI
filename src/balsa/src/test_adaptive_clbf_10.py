...
fig = plt.figure()
plt.rcParams.update({'font.size': 12})
plt.plot(x_d[0,:],x_d[1,:],'y--',label='ref')
plt.plot(x_ad[0,:],x_ad[1,:],'b--',alpha=0.9,label='ad')
...
plt.rcParams.update({'font.size': 12})
plt.subplot(211)
plt.plot(t,u_ad[0,:-1],'b--',alpha=0.9)
...
plt.subplot(212)
plt.plot(t,u_ad[1,:-1],'b--',alpha=0.9)
...
plt.rcParams.update({'font.size': 12})
plt.subplot(311)
plt.plot(t,np.sqrt((x_d[0,:]-x_ad[0,:])**2 + (x_d[1,:]-x_ad[1,:])**2),'b--',alpha=0.9)
...
plt.xlabel('Time (s)')
plt.subplot(313)
plt.plot(t,barrier_dist_ad-params["barrier_radius"],'b--',alpha=0.9)
