...
plt.plot(x_safety[0,:],x_safety[1,:],'y:',alpha=0.9,label='pd')
...
plt.plot(t,u_safety[0,:-1],'y:',alpha=0.9)
...
plt.plot(t,u_safety[1,:-1],'y:',alpha=0.9)
...
plt.plot(t,np.sqrt((x_d[0,:]-x_safety[0,:])**2 + (x_d[1,:]-x_safety[1,:])**2),'y:',alpha=0.9)
...
plt.plot(t,x_safety[3,:],'y:',alpha=0.9)
...
plt.plot(t,barrier_dist_safety-params["barrier_radius"],'y:',alpha=0.9)
