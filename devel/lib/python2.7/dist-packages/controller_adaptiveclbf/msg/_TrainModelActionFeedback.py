...
"""autogenerated by genpy from controller_adaptiveclbf/TrainModelActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class TrainModelActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "controller_adaptiveclbf/TrainModelActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','controller_adaptiveclbf/TrainModelFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TrainModelActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = controller_adaptiveclbf.msg.TrainModelFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = controller_adaptiveclbf.msg.TrainModelFeedback()
