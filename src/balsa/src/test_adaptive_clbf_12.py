...
plt.plot(t,u_balsa_save[0,:-1],'k--',alpha=0.9)
plt.plot(t,u_cbf_save[0,:-1],'b-',alpha=0.9,linewidth=3.0)
plt.plot(t,u_clf_save[0,:-1],'m-',alpha=0.9,linewidth=3.0)
...
plt.plot(t,u_balsa_save[1,:-1],'k--',alpha=0.9)
